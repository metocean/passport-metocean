...
(function() {
  ...
  Strategy = function(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || 'http://localhost:3233/odo/auth/oauth2/authorize';
    options.tokenURL = options.tokenURL || 'http://localhost:3233/odo/auth/oauth2/token';
    OAuth2Strategy.call(this, options, verify);
    this.name = 'metocean';
    this._clientSecret = options.clientSecret;
    return this._profileURL = options.profileURL || 'http://localhost:3233/odo/auth/oauth2/profile';
  };
